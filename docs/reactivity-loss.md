...
Обратите внимание, что скрипт нужно вставить в код, а не в консоль браузера. Если после перезапуска кода видно исключение в консоли браузера, то есть разные способы решения проблемы:
